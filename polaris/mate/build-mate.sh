...
#cp -r $build/deb-installer/graphics  $build/build/config/includes.installer/usr/share
#cp -r $build/deb-installer/themes $build/build/config/includes.installer/usr/share
