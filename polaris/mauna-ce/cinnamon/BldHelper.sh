...
PREFIX=MaunaLinux-25.1-Christian-Edition
SUFFIX=amd64
BUILD=christian-edition-polaris
TODAY=$(date -u +"%Y-%m-%d")
FileName="${PREFIX}-${SUFFIX}"
LOCATION="/home/$SUDO_USER/out/${BUILD}"
LogDir="/home/$SUDO_USER/logs"
WorkingDir="/home/$SUDO_USER/iso-build/polaris/mauna-ce/cinnamon"

# Execute the ISO building script
cd ${WorkingDir}
./build-cinnamon-ce 2>&1 | tee /tmp/build_log.txt
